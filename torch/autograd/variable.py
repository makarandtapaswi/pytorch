...
class Variable(_C._VariableBase):
    ...
    def masked_copy(self, mask, variable):
        warnings.warn("masked_copy is deprecated in favor of masked_scatter, and will be "
            "removed in v0.3")
        return MaskedScatter.apply(self, mask, variable)

    def masked_copy_(self, mask, variable):
        warnings.warn("masked_copy_ is deprecated in favor of masked_scatter_, and will be "
            "removed in v0.3")
